...
const Header = () => {
    return (
        <header className="2xl:hidden absolute z-40 left-0 right-0 bg-primary h-20">
                    ...
                    <Sheet>
                        ...
                        >
                            ...
                            <div>
                                ...
                                <a
                                    download
                                    className="btn btn-lg btn-tertiary mb-16 mx-2"
                                ...
                                {/* =============== SOCIALS =============== */}
                                <Socials
                                    containerStyles="flex gap-3 xl:gap-4"
