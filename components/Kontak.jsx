...
// GAMBAR SAYA
import Gambar1 from "@/public/assets/kontak/gambar.png";
            ...
            >
              <div className="flex gap-8">
                <div className="flex-1">
                  ...
                  >
                    Nama Depan <span className="text-aksen">*</span>
                  </label>
                  <input
                ...
                <div className="flex-1">
                  <label
                    ...
                    className="block mb-2 text-sm font-medium text-utama"
                  >
                    Nama Belakang <span className="text-aksen">*</span>
                  </label>
                  <input
                    onChange={tanganiPerubahan}
                    type="text"
              ...
              <div>
                <label
                  ...
                  className="block mb-2 text-sm font-medium text-utama"
                >
                  Nomor Telepon <span className="text-aksen">*</span>
                </label>
                <input
                  onChange={tanganiPerubahan}
                  type="text"
                  ...
                  <>
                    <FaCheckCircle
                      className={`absolute text-white text-lg transition-opacity duration-500 ease-in-out ${
                        tampilkanIkon ? "opacity-100" : "opacity-0"
                      }`}
                    />
                    <span
                      className={`transition-opacity duration-500 ease-in-out ${
                        tampilkanIkon ? "opacity-0" : "opacity-100"
                      }`}
                    >
                      Kirim Pesan
                    </span>
