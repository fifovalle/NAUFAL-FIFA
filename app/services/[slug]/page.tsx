        ...
        >
          ...
          <section className="grid grid-cols-1 gap-10 pb-24 md:grid-cols-2">
            <div className="rounded-3xl border bg-card/80 p-8 shadow-sm">
              <h3 className="mb-4 text-2xl font-semibold">What You Get</h3>
              <p className="text-muted-foreground leading-relaxed">
                I deliver solutions that are not only functional but also
                visually refined and technically robust. Each engagement starts
                by understanding your goals, then translating them into a clear
                roadmap.
              </p>
              <ul className="mt-6 space-y-2 text-sm text-muted-foreground">
                <li>• Discovery → scope, requirements, success metrics</li>
                <li>• Architecture → structured, scalable systems</li>
                <li>• Build & QA → iterative delivery, measurable results</li>
                <li>• Launch & Support → documentation & ongoing care</li>
              </ul>
            </div>
            ...
            <div className="rounded-3xl border bg-card/80 p-8 shadow-sm">
              ...
              <p className="text-muted-foreground leading-relaxed">
                I combine strategic thinking with solid engineering practice.
                Expect reliable execution, clean code, and interfaces that feel
          ...
          <section className="pb-24 text-center">
            <blockquote className="mx-auto max-w-3xl rounded-3xl border bg-linear-to-br from-muted/50 to-muted/30 p-8 italic text-lg leading-relaxed text-muted-foreground md:text-2xl">
              “Great software doesn’t just work—it inspires confidence, feels
            ...
            <div className="mt-12">
              ...
              <p className="max-w-xl mx-auto text-muted-foreground mb-8">
                Reach out and let’s explore how we can transform your vision
                into a scalable, high-quality digital product.
              </p>
              <Link
                href="/contact"
